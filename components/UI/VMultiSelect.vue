<template>
  <fieldset class="fg">
    ...
    <div
      :class="[
        'm-select _multi-select',
        { _open: isOpen, '_not-select': !isOpen },
      ]"
    >
...
export default {
  data() {
    return {
      ...
      options: [
        { text: 'Услуги', value: 'option1', isChecked: true },
        { text: 'Проекты', value: 'option2', isChecked: false },
        { text: 'Вакансии', value: 'option3', isChecked: false },
        { text: 'Фрилансеры', value: 'option4', isChecked: true },
      ],
    };
  },
  mounted() {
