...
const questions = ref([
  {
    ...
    answer:
      'Завтрашняя жизнь и теперь клиническая. Чистый амет тортор, а не хендрерит фазеллус ультрициес. Ему нужна, пусть это будет болезнь, теперь пусть это будет масса. Боюсь, выходных даже не будет пока. Эрроуз, это тоже были выходные.',
  },
  {
