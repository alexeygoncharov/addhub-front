...
function submitProfile() {
  ...
  if (form.value.email) formData.append('name', form.value.email);
  if (form.value.user_name) formData.append('name', form.value.user_name);
  if (form.value.phone_number) formData.append('name', form.value.phone_number);
  if (form.value.profession) formData.append('name', form.value.profession);
  if (form.value.slogan) formData.append('name', form.value.slogan);
  if (form.value.gender) formData.append('name', form.value.gender);
  if (form.value.city) formData.append('name', form.value.city);
  if (form.value.about_me) formData.append('name', form.value.about_me);
